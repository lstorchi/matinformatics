...
Run ising a single Dataset no Atomic Data 
  ...
  python3 ffilter.py -f newadata.pkl -i "./data/V_fu_added.csv,formation_energy_ev_natom"python3 ffilter.py -f newadata.pkl -i "./data/V_fu_added.csv,formation_energy_ev_natom"
